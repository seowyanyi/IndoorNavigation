    ...
    while True:
        if reached_checkpoint:
            ...
            if data['type'] == pedometer.Step.FORWARD:
                ...
                print '>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>Step taken. Heading: {} deg. {} left'.format(data['actual_bearing'], round(distance_to_next/CM_PER_STEP,1))
